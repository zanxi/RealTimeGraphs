...
public:
    ...
    QString const DateTimeFormat_ = "yyyy-MM-ddTHH:mm:ss.zzzZ";
   ...
   // ******************* Параметры Сухостойность *****************************
    ...
    //DataSystems::Instance().dataentry_library_siries_life_number = (ui->lineEdit_number_feed_types->text());
    //DataSystems::Instance().dataentry_library_siries_number = (ui->lineEdit_dry_matter->text());
    //  DataSystems::Instance().dataentry_library_siries_sire_name = (ui->lineEdit_name->text());
